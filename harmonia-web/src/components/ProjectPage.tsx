      ...
      <div className="hm-project-shell">
        ...
        <header className="hm-project-hero">
          ...
          <p className="hm-project-lead">
            Harmonia is an end-to-end system that turns human language into
            synthesizer sound. Describe what you want to hear, and an AI model
            designs a playable preset for a purpose-built synthesizer. It brings
            together three pieces — a JUCE audio plugin, a machine-learning
            engine, and a backend — into a single creative tool for music
          ...
          <div className="hm-metrics-inner">
            <div className="hm-metrics-text">
              ...
              <p className="hm-metrics-desc">
                Adoption, generations, model performance and system health — all
                of it is tracked on a dedicated metrics dashboard, updated in
                real time.
              </p>
            </div>
            <a
          ...
          <div className="hm-pipeline">
            {PIPELINE.map((step, i) => (
              <div className="hm-pipeline-step" key={step.title}>
                ...
                <div className="hm-pipeline-num">Step {i + 1}</div>
                <h3>{step.title}</h3>
                <p>{step.text}</p>
                {i < PIPELINE.length - 1 && (
                  <span className="hm-pipeline-arrow" aria-hidden="true">
                    →
                  </span>
                )}
              </div>
        ...
        <section className="hm-section">
          <div className="hm-section-head">
            ...
            <h2 className="hm-section-title">Three components, one system</h2>
          </div>
            ...
            {REPOS.map((r) => (
              ...
              >
                ...
                <div className="hm-repo-body">
                  <span className="hm-repo-name">{r.name}</span>
                  <span className="hm-repo-desc">{r.desc}</span>
                </div>
                <ArrowUpRight
                  size={16}
                  strokeWidth={2}
        ...
        <section className="hm-final-cta">
          ...
          <p>
            Harmonia is experimental and evolving fast. Download the plugin,
            generate a few presets, and send us your feedback — it shapes every
            next version.
          </p>
