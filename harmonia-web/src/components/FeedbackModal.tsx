  ...
  return (
    ...
    >
      <div className="hm-modal" onClick={(e) => e.stopPropagation()}>
        <button className="hm-modal-close" onClick={onClose} aria-label="Close">
        ...
        {status === 'success' ? (
          <div className="hm-modal-success">
            ...
            <h3>Thank you!</h3>
            <p>
              Your feedback was sent to the Harmonia team. It helps shape the
              next versions.
            </p>
          ...
          <form className="hm-modal-form" onSubmit={handleSubmit}>
            ...
            <p className="hm-modal-sub">
              Harmonia is experimental — your input directly guides what we
              build next.
            </p>
            ...
            <div className="hm-cat-row">
              {CATEGORIES.map((c) => (
                <button
                  type="button"
                  key={c}
                  className={`hm-cat-chip ${category === c ? 'is-active' : ''}`}
